...
public class MaxMax {
     ...
     */
    public static int twoMaxGreatThanMax1(int arr[]){
        //2n comparisons
        // initialization
        int max1 = arr[0];
        int max2 = arr[1];
     ...
     * @return variable count the number of comparisons
     */
    public static int twoMaxGreatThanMax2(int arr[]){
        //n comparisons
        // initialization
        int max1 = arr[0];
        int max2 = arr[1];
    ...
    public static int twoMaxPairs1(int arr[]){
        //(3/2)*n comparisons
        // initialization
        int max1 = arr[0];
        int max2 = arr[1];
    ...
    public static int twoMaxPairs2(int arr[]){
        //n comparisons
        // initialization
        int max1 = arr[0];
        int max2 = arr[1];
    ...
    public static void checkTimes(){
        ...
        for (int i = 1; i<=loop; i++){
            int arr[] = randomIntArrayOfDiffNumbers(size);
